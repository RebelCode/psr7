...
class StreamTest extends TestCase
{
    ...
    private function assertStreamStateAfterClosedOrDetached(Stream $stream): void
    {
        ...
        if (\PHP_VERSION_ID >= 70400) {
            ...
            self::assertStringStartsWith('RebelCode\Psr7\Stream::__toString exception', $errors[0]['message']);
...
namespace RebelCode\Psr7;

use RebelCode\Tests\Psr7\StreamTest;
