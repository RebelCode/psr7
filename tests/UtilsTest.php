...
use RebelCode\Psr7;
use RebelCode\Psr7\FnStream;
use RebelCode\Psr7\NoSeekStream;
...
class UtilsTest extends TestCase
{
    ...
    {
        self::assertInstanceOf('RebelCode\Psr7\Uri', Psr7\Utils::uriFor('/foo'));
    ...
    public function testCreatesWithFactory(): void
    {
        ...
        self::assertInstanceOf('RebelCode\Psr7\Stream', $stream);
    ...
    public function testFactoryCreatesFromEmptyString(): void
    {
        ...
        self::assertInstanceOf('RebelCode\Psr7\Stream', $s);
    }
    ...
    public function testCanCreateIteratorBasedStream(): void
    {
        ...
        self::assertInstanceOf('RebelCode\Psr7\PumpStream', $p);
    ...
    public function testReturnsAsIsWhenNoChanges(): void
    {
        $r1 = new Psr7\Request('GET', 'http://foo.com');
        $r2 = Psr7\Utils::modifyRequest($r1, []);
        self::assertInstanceOf('RebelCode\Psr7\Request', $r2);
    ...
    public function testModifyServerRequestWithUploadedFiles(): void
    {
        ...
        self::assertInstanceOf('RebelCode\Psr7\UploadedFile', $files[0]);
    }
