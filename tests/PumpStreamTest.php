...
use RebelCode\Psr7;
use RebelCode\Psr7\LimitStream;
use RebelCode\Psr7\PumpStream;
...
class PumpStreamTest extends TestCase
{
    ...
    public function testThatConvertingStreamToStringWillTriggerErrorAndWillReturnEmptyString(): void
    {
        ...
        self::assertStringStartsWith('RebelCode\Psr7\PumpStream::__toString exception:', $errors[0]['message']);
    }
}
